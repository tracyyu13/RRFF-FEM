...
grids = []
grids.append(np.linspace(0, 1, 101, dtype=np.float32))
grids.append(np.linspace(0, 1, 101, dtype=np.float32))
...
with open('Helmholtz_data_noise.txt','w') as f:
...
im1 = ax[0].imshow(x_train_noise[idx].reshape(101,101), interpolation='bilinear', cmap= "coolwarm", origin= 'lower')
ax[0].set_xticks(np.linspace(0,100,5))
ax[0].set_yticks(np.linspace(0,100,5))
...
# training output
im2 = ax[1].imshow(y_train_noise[idx].reshape(101,101), interpolation='bilinear', cmap= "coolwarm", origin= 'lower')
ax[1].set_xticks(np.linspace(0,100,5))
ax[1].set_yticks(np.linspace(0,100,5))
...
ax[0].set_title('Training Input', fontsize=13)
ax[1].set_title('Training Output', fontsize=13)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_training_data.png', bbox_inches = 'tight')
...
# Save data to text file
with open('Helmholtz_test_pred_Gaussian.txt','w') as f:
...
prediction1 = pred1[idx].reshape(101,101)
prediction2 = pred2[idx].reshape(101,101)
...
ax[2].set_yticks(np.linspace(0,100,5))
...
ax[0].set_title('Test Example', fontsize=13)
ax[1].set_title('RFF Prediction', fontsize=13)
ax[2].set_title(f'RRFF Prediction: \u03b1 = {alpha}', fontsize=13)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_test_pred_Gaussian.png', bbox_inches = 'tight')
...
ax[0].set_title('RFF Pointwise Error', fontsize=13)
ax[1].set_title(f'RRFF Pointwise Error: \u03b1 = {alpha}', fontsize=13)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_error_Gaussian.png', bbox_inches = 'tight')
...
# Save data to text file
with open('Helmholtz_test_pred_Student2.txt','w') as f:
    np.savetxt(f, W, delimiter=',')
    f.write('\n')
    np.savetxt(f, x_train_RF, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_test_pred_Student2.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_error_Student2.png', bbox_inches = 'tight')
...
# Save data to text file
with open('Helmholtz_test_pred_Student3.txt','w') as f:
    np.savetxt(f, W, delimiter=',')
    f.write('\n')
    np.savetxt(f, x_train_RF, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_test_pred_Student3.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_error_Student3.png', bbox_inches = 'tight')
...
# Save data to text file
with open('Helmholtz_data_split.txt','w') as f:
...
# Save data to text file
with open('Helmholtz_recovery_Gaussian.txt','w') as f:
...
true = y_test[M + idx].reshape(101,101)
interpolant1 = v_out1[idx].reshape(101,101)
interpolant2 = v_out2[idx].reshape(101,101)
...
ax[0].set_title('Test Example', fontsize=13)
ax[1].set_title('RFF + FEM Prediction', fontsize=13)
ax[2].set_title(f'RRFF + FEM Prediction: \u03b1 = {alpha}', fontsize=13)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_recovery_interpolant_Gaussian.png', bbox_inches = 'tight')
...
ax[0].set_title('Pointwise Error - RFF + FEM', fontsize=13)
ax[1].set_title(f'Pointwise Error - RRFF + FEM: \u03b1 = {alpha}', fontsize=13)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_recovery_error_Gaussian.png', bbox_inches = 'tight')
...
# Save data to text file
with open('Helmholtz_recovery_Student2.txt','w') as f:
    np.savetxt(f, W_split, delimiter=',')
    f.write('\n')
    np.savetxt(f, b_split, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_recovery_interpolant_Student2.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_recovery_error_Student2.png', bbox_inches = 'tight')
...
# Save data to text file
with open('Helmholtz_recovery_Student3.txt','w') as f:
    np.savetxt(f, W_split, delimiter=',')
    f.write('\n')
    np.savetxt(f, b_split, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_recovery_interpolant_Student3.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('Helmholtz_recovery_error_Student3.png', bbox_inches = 'tight')