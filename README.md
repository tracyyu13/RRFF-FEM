# RRFF-FEM
This repository contains code for the paper "Regularized Random Fourier Features and Finite Element Reconstruction for Operator Learning in Sobolev Space."
### Citation
