...
grids = []
grids.append(np.linspace(0, 2*np.pi, 64, dtype=np.float32))
grids.append(np.linspace(0, 2*np.pi, 64, dtype=np.float32))
...
print('Added noise to input data \n')
...
print('Added noise to output data \n')

# Save data to text file
with open('NS_data_noise.txt','w') as f:
...
im1 = ax[0].imshow(x_train_noise[idx].reshape(64,64), interpolation='bilinear', cmap= "coolwarm", origin= 'lower')
ax[0].set_xticks(np.linspace(0,63,3))
ax[0].set_yticks(np.linspace(0,63,3))
ax[0].set_xticklabels(['0','π','2π'])
ax[0].set_yticklabels(['0','π','2π'])
divider = make_axes_locatable(ax[0])
cax1 = divider.append_axes("right", size="5%", pad=0.05)
fig.colorbar(im1, cax=cax1).formatter.set_powerlimits((0, 0))

# training output
im2 = ax[1].imshow(y_train_noise[idx].reshape(64,64), interpolation='bilinear', cmap= "coolwarm", origin= 'lower')
ax[1].set_xticks(np.linspace(0,63,3))
ax[1].set_yticks(np.linspace(0,63,3))
ax[1].set_xticklabels(['0','π','2π'])
ax[1].set_yticklabels(['0','π','2π'])
divider = make_axes_locatable(ax[1])
cax2 = divider.append_axes("right", size="5%", pad=0.05)
fig.colorbar(im2, cax=cax2).formatter.set_powerlimits((0, 0))

ax[0].set_title('Training Input', fontsize=11)
ax[1].set_title('Training Output', fontsize=11)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_training_data.png', bbox_inches = 'tight')
...
# Save data to text file
with open('NS_test_pred_Gaussian.txt','w') as f:
...
prediction1 = pred1[idx].reshape(64,64)
prediction2 = pred2[idx].reshape(64,64)
...
ax[2].set_xticks(np.linspace(0,63,3))
ax[2].set_yticks(np.linspace(0,63,3))
ax[2].set_xticklabels(['0','π','2π'])
ax[2].set_yticklabels(['0','π','2π'])
divider = make_axes_locatable(ax[2])
cax3 = divider.append_axes("right", size="5%", pad=0.05)
fig.colorbar(im3, cax=cax3).formatter.set_powerlimits((0, 0))

ax[0].set_title('Test Example', fontsize=11)
ax[1].set_title('RFF Prediction', fontsize=11)
ax[2].set_title(f'RRFF Prediction: \u03b1 = {alpha}', fontsize=11)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_test_pred_Gaussian.png', bbox_inches = 'tight')
...
ax[0].set_title('RFF Pointwise Error', fontsize=11)
ax[1].set_title(f'RRFF Pointwise Error: \u03b1 = {alpha}', fontsize=11)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_error_Gaussian.png', bbox_inches = 'tight')
...
# Save data to text file
with open('NS_test_pred_Student2.txt','w') as f:
    np.savetxt(f, W, delimiter=',')
    f.write('\n')
    np.savetxt(f, x_train_RF, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_test_pred_Student2.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_error_Student2.png', bbox_inches = 'tight')
...
# Save data to text file
with open('NS_test_pred_Student3.txt','w') as f:
    np.savetxt(f, W, delimiter=',')
    f.write('\n')
    np.savetxt(f, x_train_RF, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_test_pred_Student3.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_error_Student3.png', bbox_inches = 'tight')
...
# Save data to text file
with open('NS_data_split.txt','w') as f:
...
# Save data to text file
with open('NS_recovery_Gaussian.txt','w') as f:
...
true = y_test[M + idx].reshape(64,64)
interpolant1 = v_out1[idx].reshape(64,64)
interpolant2 = v_out2[idx].reshape(64,64)
...
ax[0].set_title('Test Example', fontsize=11)
ax[1].set_title('RFF + FEM Prediction', fontsize=11)
ax[2].set_title(f'RRFF + FEM Prediction: \u03B1 = {alpha}', fontsize=11)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_recovery_interpolant_Gaussian.png', bbox_inches = 'tight')
...
ax[0].set_title('Pointwise Error - RFF + FEM', fontsize=11)
ax[1].set_title(f'Pointwise Error - RRFF + FEM: \u03b1 = {alpha}', fontsize=11)
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_recovery_error_Gaussian.png', bbox_inches = 'tight')
...
# Save data to text file
with open('NS_recovery_Student2.txt','w') as f:
    np.savetxt(f, W_split, delimiter=',')
    f.write('\n')
    np.savetxt(f, b_split, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_recovery_interpolant_Student2.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_recovery_error_Student2.png', bbox_inches = 'tight')
...
# Save data to text file
with open('NS_recovery_Student3.txt','w') as f:
    np.savetxt(f, W_split, delimiter=',')
    f.write('\n')
    np.savetxt(f, b_split, delimiter=',')
    f.write('\n')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_recovery_interpolant_Student3.png', bbox_inches = 'tight')
...
plt.grid(visible=False)
plt.tight_layout()
plt.savefig('NS_recovery_error_Student3.png', bbox_inches = 'tight')